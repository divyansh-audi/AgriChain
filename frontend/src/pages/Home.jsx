...
const Home = () => {
  ...
  const getMainCTAButton = () => {
    if (!connected) {
      return {
        ...
        description: 'Connect your wallet to access AgriChain services'
      };
    } else if (!isRegistered()) {
      return {
  ...
  const handleFeatureClick = (title) => {
    const routes = {
      'Weather-Triggered Insurance': '/insurance',
      'Cross-Chain Microloans': '/loans',
      'Crop Carbon Credit Tokenization': '/carbon-credits',
      'Real-Time Data Feeds': '/market-data',
    };
    navigate(routes[title] || '/dashboard');
  };
        ...
        <Container maxWidth="lg" sx={{ px: { xs: 3, md: 4 }, position: 'relative', zIndex: 1 }}>
          <Fade in={isVisible} timeout={1200}>
            <Box>
              ...
              >
                🌾 AgriChain Global Farmers Market
              </Typography>
